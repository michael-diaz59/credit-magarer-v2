...
import type { GeneralSummary, ProfitDetails, EquityDetails } from "../business/entities/Summary";
import type { GetExpensivesError, GetExpensivesOutput } from "../business/useCases/GetExpensivesCase";
...
export interface SummaryGateway {
    ...
    getExpensivesDetails(input: { companyId: string }): Promise<Result<GetExpensivesOutput, GetExpensivesError>>;
