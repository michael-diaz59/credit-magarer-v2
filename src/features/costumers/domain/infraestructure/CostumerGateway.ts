...
export default interface CostumerGateway {
    ...
    UpdateCostumer(costumer: Costumer,companyId: string): Promise<Result<void, SaveCostumerError>>
    createCostumer(costumer: Costumer,companyId: string): Promise<Result<void, SaveCostumerError>>
